...
INSERT INTO "new_SiteSetting" ("address", "brandName", "contactEmail", "contactPhone", "heroCta", "heroHeadline", "heroSubheadline", "id", "logoMode", "logoUrl", "privacyPolicy", "seoDescription", "seoTitle", "socials", "tagline", "termsOfService", "updatedAt") SELECT "address", "brandName", "contactEmail", "contactPhone", "heroCta", "heroHeadline", "heroSubheadline", "id", "logoMode", "logoUrl", "privacyPolicy", "seoDescription", "seoTitle", "socials", "tagline", "termsOfService", "updatedAt" FROM "SiteSetting";
