...
export function Galaxy({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      canvas.width = Math.max(1, Math.floor(ctn.offsetWidth * scale));
      canvas.height = Math.max(1, Math.floor(ctn.offsetHeight * scale));
    ...
    function update(t: number) {
      ...
      if (!disableAnimation) {
        ...
        gl.uniform1f(uniforms.uStarSpeed, (t * 0.001 * starSpeed) / 10);
      }
